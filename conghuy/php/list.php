		...
		<div class="container main mt-5">
			<div class="row main-height">
				...
				<?php 
						...
						require('./ketnoi.php');
						$a = $_GET['MaLoai'];
						$sql = "SELECT * FROM tintuc where MaLoaiTin= $a group by MaTin desc limit 1";
						if($result = mysqli_query($link,$sql)){
							$detail=mysqli_fetch_array($result);
									do{
										echo '
				...
				<div class="col-md-4 main-right hidden">
					...
					<?php 
						/* in ra thẻ li */
						require('./ketnoi.php');
						$sql = "SELECT * FROM tintuc where MaLoaiTin=$a group by MaTin desc limit 2,5";
						if($result = mysqli_query($link,$sql)){
							$detail=mysqli_fetch_array($result);
									do{
										echo '
		...
		<div class="container section ">
			<div class="section-item mt-3">
				<h4><?php 
						/* in ra thẻ li */
						require('./ketnoi.php');
						$sql = "SELECT * FROM loaitin where MaLoai=$a";
						if($result = mysqli_query($link,$sql)){
							$detail=mysqli_fetch_array($result);
									do{
										echo $detail["TenLoai"];
				...
				<div class="row">
					<?php 
						/* in ra thẻ li */
						require('./ketnoi.php');
						$sql = "SELECT * FROM tintuc where MaLoaiTin=$a group by MaTin desc limit 6,20";
						if($result = mysqli_query($link,$sql)){
							$detail=mysqli_fetch_array($result);
									do{
										echo '
